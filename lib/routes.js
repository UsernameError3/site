...
},
{
    ...
    handler: (req, res) => {
        res.view('background-generator', { title: 'background-generator', currentYear: currentYear }, { layout: 'generator' });
    }
},
{
    method: 'GET',
    path: '/register',
    handler: (req, res) => {
        res.redirect('https://hacksi2019.eventbrite.com');
    }
},
{
    method: 'GET',
...
},
{
    ...
    path: '/instagram',
    handler: (req, res) => {
        res.redirect('https://instagram.com/hacksi2019');
    }
},
{
    method: 'GET',
...
},
{
    ...
    path: '/tracker',
    handler: (req, res) => {
        res.redirect('https://goo.gl/forms/wBnbzfOXppesTaG12');
    }
},
{
    method: 'GET',
...
},
{
    ...
    path: '/survey',
    handler: (req, res) => {
        res.redirect('https://goo.gl/forms/lA16sfqIcw61lOrb2');
    }
},
{
    method: 'GET',
...
},
{
    ...
    path: "/wallpaper",
    handler: (req, res) => {
        res.view('wallpaper', { title: 'wallpaper', currentYear: currentYear, banners: getBanners() });
    }
},
{
    method: "GET",
